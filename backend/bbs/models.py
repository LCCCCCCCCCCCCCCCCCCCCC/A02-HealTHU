...
class Floor(models.Model):
    ...
    aboveName = models.CharField(max_length=20) # (if not the original post) the nickname of the user who posted the floor that this post is replying to
    aboveContent = models.CharField(max_length=200) # (if not the original post) the content of the floor that this post is replying to
