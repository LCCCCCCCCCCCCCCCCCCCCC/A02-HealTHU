...
Page({
  ...
  data: {
    ...
    bbsactivate: 0,
    noticeList: [
      {state:0, title:"GUMI报名了你的活动“软件学院集体锻炼”", time:"2023-12-19 18:20", url: '../activities/activity/activity?actid=1'},
      {state:1, title:"teto评论了你的动态“今天真冷啊...”", time:"2023-12-18 14:02", url: '../personal/personal'},
    ],
    bbsList: [
      {title:"今天真冷啊..", time:"12-18 13:42", reply: 1, url: '../bbs/bbs?bbsid=103'},
      {title:"2023秋软件学院集体锻炼", time:"12-18 9:20", url: '../activities/activity/activity?actid=1'},
      {title:"[提问氵]西操体育馆几点开放啊", time:"12-17 18:56", reply: 1, url: '../bbs/bbs?bbsid=102'},
      {title:"[失物招领]在紫操西北角捡到一串钥匙，已经交到紫荆一楼了", reply: 0, time:"12-17 17:30", url: '../bbs/bbs?bbsid=101'},
    ]
  },
  delUnread(event){
